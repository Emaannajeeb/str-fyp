...
import { Loader2, Wallet, Pause, X, ExternalLink } from 'lucide-react';
  ...
  return (
    <div>
      ...
      <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">{stream.contract.tokenSymbol} Payment Stream</p>
              </div>
            </div>
            <span
        ...
        {/* Actions */}
        {stream.status === 'ACTIVE' && (canPauseStream || canCancelStream) && !permissionsLoading && (
